...
def setup_filter(coords, minyear, maxyear):
    ...
    date_filter = {
        ...
        "config": {
            ...
            "lt":"{}-04-01T00:00:00Z".format(maxyear)
            }
        }
...
def main(argv):
    ...
    geometry_path = "/projectnb/modislc/users/mkmoon/Planet/rawImage/geojson"
    min_year = 2017
    max_year = 2023
    output_dir = "/projectnb/modislc/users/mkmoon/Planet/rawImage/rawImage"
