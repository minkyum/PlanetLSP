###############################
library(rjson)
params <- fromJSON(file='/projectnb/modislc/users/mkmoon/sukyungkim/LSP/data_paper/PLSP_Parameters.json')
